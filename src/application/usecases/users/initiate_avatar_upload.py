...
class InitiateAvatarUploadUseCase(UseCase):
    ...
    async def execute(self, user_id: UUID, filename: str, content_type: str) -> AvatarPresignedUrlResponse:
        ...
        return AvatarPresignedUrlResponse(upload_url=upload_url, object_key=object_key)
